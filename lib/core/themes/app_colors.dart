...
class AppColors {
  ...
  // main colors
  static const Color primary0 = Color(0xffe7f3ec);
  static const Color primary25 = Color(0xffb5d8c5);
  static const Color primary50 = Color(0xff91c6a9);
  static const Color primary100 = Color(0xff5fab82);
  static const Color primary200 = Color(0xff409b69);
  ...
  static const Color error200 = Color(0xff96132c);
  ...
  // success
  static const Color success300 = Color(0xff184e44);
  static const Color success200 = Color(0xff28806f);
  static const Color success100 = Color(0xff40c4aa);
  static const Color success50 = Color(0xff9ee1d4);
